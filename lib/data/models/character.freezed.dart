...
class _$CharacterTearOff {
  ...
  _Character call({required List<Results> results}) {
    return _Character(
      results: results,
    );
  }
...
class _$_Character implements _Character {
  const _$_Character({required this.results});
...
abstract class _Character implements Character {
  const factory _Character({required List<Results> results}) = _$_Character;
